...
func (x *Target) GetValue() isTarget_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Target) GetPvp() *Target_Pvp {
	if x != nil {
		if x, ok := x.Value.(*Target_Pvp_); ok {
			return x.Pvp
		}
	}
	return nil
...
func (x *Target) GetPve() *Target_Pve {
	if x != nil {
		if x, ok := x.Value.(*Target_Pve_); ok {
			return x.Pve
		}
	}
	return nil
...
type Target_Pve struct {
	...
	Dungeons      map[int32]int64        `protobuf:"bytes,3,rep,name=dungeons,proto3" json:"dungeons,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // incell map
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_tableau_protobuf_unittest_common_proto_rawDesc = string([]byte{
	...
	0xb5, 0x18, 0x07, 0x1a, 0x05, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x2a, 0x9f, 0x01, 0x0a, 0x09, 0x46,
	...
	,
...
var (
	...
	file_tableau_protobuf_unittest_common_proto_rawDescData []byte
)
...
func file_tableau_protobuf_unittest_common_proto_rawDescGZIP() []byte {
	file_tableau_protobuf_unittest_common_proto_rawDescOnce.Do(func() {
		file_tableau_protobuf_unittest_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tableau_protobuf_unittest_common_proto_rawDesc), len(file_tableau_protobuf_unittest_common_proto_rawDesc)))
	})
...
var file_tableau_protobuf_unittest_common_proto_goTypes = []any{
...
func file_tableau_protobuf_unittest_common_proto_init() {
	...
	file_tableau_protobuf_unittest_common_proto_msgTypes[1].OneofWrappers = []any{
		(*Target_Pvp_)(nil),
		(*Target_Pve_)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tableau_protobuf_unittest_common_proto_rawDesc), len(file_tableau_protobuf_unittest_common_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
