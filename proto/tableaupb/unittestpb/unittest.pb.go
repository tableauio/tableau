...
type IncellMap struct {
	...
	FruitMap      map[int32]*IncellMap_Fruit `protobuf:"bytes,1,rep,name=fruit_map,json=fruitMap,proto3" json:"fruit_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	FlavorMap     map[int64]FruitFlavor      `protobuf:"bytes,2,rep,name=flavor_map,json=flavorMap,proto3" json:"flavor_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=unittest.FruitFlavor"`
	ItemMap       map[int32]*IncellMap_Item  `protobuf:"bytes,3,rep,name=item_map,json=itemMap,proto3" json:"item_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type ItemConf struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ItemMap       map[uint32]*Item       `protobuf:"bytes,1,rep,name=item_map,json=itemMap,proto3" json:"item_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MallConf struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	ShopMap       map[uint32]*MallConf_Shop `protobuf:"bytes,1,rep,name=shop_map,json=shopMap,proto3" json:"shop_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RewardConf struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	RewardMap     map[uint32]*RewardConf_Reward `protobuf:"bytes,1,rep,name=reward_map,json=rewardMap,proto3" json:"reward_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PatchMergeConf struct {
	...
	ItemMap          map[uint32]*Item       `protobuf:"bytes,7,rep,name=item_map,json=itemMap,proto3" json:"item_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	ReplaceItemMap   map[uint32]*Item       `protobuf:"bytes,8,rep,name=replace_item_map,json=replaceItemMap,proto3" json:"replace_item_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type RecursivePatchConf struct {
	state         protoimpl.MessageState              `protogen:"open.v1"`
	ShopMap       map[uint32]*RecursivePatchConf_Shop `protobuf:"bytes,1,rep,name=shop_map,json=shopMap,proto3" json:"shop_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MallConf_Shop struct {
	...
	GoodsMap      map[uint32]*MallConf_Shop_Goods `protobuf:"bytes,2,rep,name=goods_map,json=goodsMap,proto3" json:"goods_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RewardConf_Reward struct {
	...
	ItemMap       map[uint32]*Item       `protobuf:"bytes,2,rep,name=item_map,json=itemMap,proto3" json:"item_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RecursivePatchConf_Shop struct {
	state         protoimpl.MessageState                    `protogen:"open.v1"`
	ShopId        uint32                                    `protobuf:"varint,1,opt,name=shop_id,json=shopId,proto3" json:"shop_id,omitempty"`
	GoodsMap      map[uint32]*RecursivePatchConf_Shop_Goods `protobuf:"bytes,2,rep,name=goods_map,json=goodsMap,proto3" json:"goods_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RecursivePatchConf_Shop_Goods struct {
	...
	CurrencyMap   map[uint32]*RecursivePatchConf_Shop_Goods_Currency `protobuf:"bytes,3,rep,name=currency_map,json=currencyMap,proto3" json:"currency_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type RecursivePatchConf_Shop_Goods_Currency struct {
	...
	PriceList     []int32                `protobuf:"varint,2,rep,packed,name=price_list,json=priceList,proto3" json:"price_list,omitempty"`
	ValueList     map[int32]int32        `protobuf:"bytes,3,rep,name=value_list,json=valueList,proto3" json:"value_list,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	MessageList   map[int32][]byte       `protobuf:"bytes,4,rep,name=message_list,json=messageList,proto3" json:"message_list,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_tableau_protobuf_unittest_unittest_proto_rawDesc = string([]byte{
...
var (
	...
	file_tableau_protobuf_unittest_unittest_proto_rawDescData []byte
)
...
func file_tableau_protobuf_unittest_unittest_proto_rawDescGZIP() []byte {
	file_tableau_protobuf_unittest_unittest_proto_rawDescOnce.Do(func() {
		file_tableau_protobuf_unittest_unittest_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tableau_protobuf_unittest_unittest_proto_rawDesc), len(file_tableau_protobuf_unittest_unittest_proto_rawDesc)))
	})
...
var file_tableau_protobuf_unittest_unittest_proto_goTypes = []any{
...
func file_tableau_protobuf_unittest_unittest_proto_init() {
	...
	file_tableau_protobuf_unittest_unittest_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tableau_protobuf_unittest_unittest_proto_rawDesc), len(file_tableau_protobuf_unittest_unittest_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   34,
			NumExtensions: 0,
			NumServices:   0,
