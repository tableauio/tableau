...
type Field_ListEntry struct {
	...
	FullElemType string `protobuf:"bytes,2,opt,name=full_elem_type,json=fullElemType,proto3" json:"full_elem_type,omitempty"`
}
...
func (x *Field_ListEntry) GetFullElemType() string {
	if x != nil {
		return x.FullElemType
	}
	return ""
}
...
type Field_MapEntry struct {
	...
	FullValueType string `protobuf:"bytes,3,opt,name=full_value_type,json=fullValueType,proto3" json:"full_value_type,omitempty"`
}
...
func (x *Field_MapEntry) GetFullValueType() string {
	if x != nil {
		return x.FullValueType
	}
	return ""
}
...
var file_tableau_protobuf_workbook_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x65, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x12, 0x24, 0x0a, 0x0e, 0x66, 0x75, 0x6c, 0x6c,
	0x5f, 0x65, 0x6c, 0x65, 0x6d, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x66, 0x75, 0x6c, 0x6c, 0x45, 0x6c, 0x65, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x1a, 0x6c,
	...
	0x54, 0x79, 0x70, 0x65, 0x12, 0x26, 0x0a, 0x0f, 0x66, 0x75, 0x6c, 0x6c, 0x5f, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x66,
	0x75, 0x6c, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x54, 0x79, 0x70, 0x65, 0x42, 0x2e, 0x5a, 0x2c,
