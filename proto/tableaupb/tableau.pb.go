...
// Field data span, to replace Type.
//  - map: span, map-value: subspan
//  - list: span, list-element: subspan
type Span int32

const (
	Span_SPAN_CROSS_CELL Span = 0 // The field data spans cross multiple cells.
	Span_SPAN_INNER_CELL Span = 1 // The field data spans only in one cell.
)
...
const (
	...
	// list in a cell:
	// - the list **Element** must be **Scalar** or **Enum** type
	// - format: ',' separated items
	Type_TYPE_INCELL_LIST Type = 24
	// map in a cell:
	// - both the **Key** and **Value** must be **Scalar** or **Enum** type
...
var file_tableau_protobuf_tableau_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x2a, 0x30, 0x0a, 0x04, 0x53, 0x70, 0x61, 0x6e, 0x12, 0x13, 0x0a, 0x0f,
	0x53, 0x50, 0x41, 0x4e, 0x5f, 0x43, 0x52, 0x4f, 0x53, 0x53, 0x5f, 0x43, 0x45, 0x4c, 0x4c, 0x10,
	0x00, 0x12, 0x13, 0x0a, 0x0f, 0x53, 0x50, 0x41, 0x4e, 0x5f, 0x49, 0x4e, 0x4e, 0x45, 0x52, 0x5f,
	0x43, 0x45, 0x4c, 0x4c, 0x10, 0x01, 0x2a, 0xa0, 0x02, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12,
...
var file_tableau_protobuf_tableau_proto_goTypes = []interface{}{
	(Span)(0),                             // 0: tableau.Span
	(Type)(0),                             // 1: tableau.Type
	(Layout)(0),                           // 2: tableau.Layout
...
var file_tableau_protobuf_tableau_proto_depIdxs = []int32{
	1,  // 0: tableau.FieldOptions.type:type_name -> tableau.Type
	2,  // 1: tableau.FieldOptions.layout:type_name -> tableau.Layout
	6,  // 2: tableau.FieldOptions.prop:type_name -> tableau.FieldProp
	9,  // 3: tableau.workbook:extendee -> google.protobuf.FileOptions
	10, // 4: tableau.worksheet:extendee -> google.protobuf.MessageOptions
	11, // 5: tableau.field:extendee -> google.protobuf.FieldOptions
	12, // 6: tableau.enum:extendee -> google.protobuf.EnumOptions
	13, // 7: tableau.evalue:extendee -> google.protobuf.EnumValueOptions
	3,  // 8: tableau.workbook:type_name -> tableau.WorkbookOptions
	4,  // 9: tableau.worksheet:type_name -> tableau.WorksheetOptions
	5,  // 10: tableau.field:type_name -> tableau.FieldOptions
	7,  // 11: tableau.enum:type_name -> tableau.EnumOptions
	8,  // 12: tableau.evalue:type_name -> tableau.EnumValueOptions
