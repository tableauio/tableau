...
type FieldProp struct {
	...
	// Specify the count of union fields the list will occupy (one list element
	// for each field). It will also the change this list field's layout from
	// incell to horizontal.
	// Zero value means the list will occupy all following fields.
	UnionFields *uint32 `protobuf:"varint,15,opt,name=union_fields,json=unionFields,proto3,oneof" json:"union_fields,omitempty"`
}
...
var file_tableau_protobuf_tableau_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x22, 0xd0, 0x03, 0x0a, 0x09, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x50, 0x72, 0x6f, 0x70,
	...
	0x62, 0x73, 0x65, 0x70, 0x12, 0x26, 0x0a, 0x0c, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x5f, 0x66, 0x69,
	0x65, 0x6c, 0x64, 0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x02, 0x52, 0x0b, 0x75, 0x6e,
