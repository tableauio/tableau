...
type FieldProp struct {
	...
	// Modify the layout of a list field of union's nested message
	// from incell to horizontal, and specify the field num
	// the list now occupies(one list element for each field).
	// Zero value means the list occupies all following fields.
