...
var (
	Order_name = map[int32]string{
		...
		1: "ORDER_ASC",
		2: "ORDER_DESC",
		3: "ORDER_STRICTLY_ASC",
		4: "ORDER_STRICTLY_DESC",
	}
	Order_value = map[string]int32{
		"ORDER_NONE":          0,
		"ORDER_ASC":           1,
		"ORDER_DESC":          2,
		"ORDER_STRICTLY_ASC":  3,
		"ORDER_STRICTLY_DESC": 4,
	}
)
...
func (Order) Descriptor() protoreflect.EnumDescriptor {
	return file_tableau_protobuf_tableau_proto_enumTypes[5].Descriptor()
}

func (Order) Type() protoreflect.EnumType {
	return &file_tableau_protobuf_tableau_proto_enumTypes[5]
}
...
type WorksheetOptions struct {
	...
	ScatterWithoutBookName bool `protobuf:"varint,23,opt,name=scatter_without_book_name,json=scatterWithoutBookName,proto3" json:"scatter_without_book_name,omitempty"`
	// Protovalidate message-level rules. The value is a text-format
	// representation of buf.validate.MessageRules, e.g.: "cel_expression:\"this.item_map.size() > 0\"".
	//
	...
	// Valid keys are: OrderedMap, Index, OrderedIndex.
	...
	// Generate OrderedIndex accessers, and multiple index columns are comma-separated.
	// Formats are same with index.
	OrderedIndex []string `protobuf:"bytes,53,rep,name=ordered_index,json=orderedIndex,proto3" json:"ordered_index,omitempty"`
}
...
func (x *WorksheetOptions) GetValidate() string {
	if x != nil {
		return x.Validate
	}
	return ""
...
func (x *WorksheetOptions) GetUnionShardSize() int32 {
	if x != nil {
		return x.UnionShardSize
	}
	return 0
}
...
func (x *WorksheetOptions) GetOrderedIndex() []string {
	if x != nil {
		return x.OrderedIndex
	}
	return nil
}
...
type FieldProp struct {
	...
	// Protovalidate field-level rules of scalar and well-known types. The value is
	// a text-format representation of buf.validate.FieldRules, e.g.: "string:{max_len:10}".
	//
	// See https://github.com/bufbuild/protovalidate.
	Validate string `protobuf:"bytes,18,opt,name=validate,proto3" json:"validate,omitempty"`
	// Protovalidate field-level rules of complex types: list, map. The value is a text-format
	// representation of buf.validate.FieldRules, e.g.: "repeated:{min_items:1}".
	//
	// See https://github.com/bufbuild/protovalidate.
	...
	// If true, this incell map/list field aggregates elements from repeated
	// visits to the same enclosing message into a single combined collection.
	// Repeated visits occur when multiple rows or columns parse into the same
	// message, e.g.:
	//   - vertical map/keyed-list with same key across rows
	//   - horizontal map with same key across columns
	//   - vertical/horizontal list spanning multiple rows/columns (sibling
	//     incell fields revisited per row or column)
	//
	// Without aggregate (default): all visits must produce the identical incell
	// value, otherwise error E2023 is reported.
	//
	// With aggregate:
	//   - incell map: merges entries from each visit; duplicate map keys across
	//     visits report error E2005.
	//   - incell list: appends elements from each visit unconditionally.
	//   - incell keyed-list: appends elements from each visit; duplicate keys
	//     across visits report error E2028.
...
func (x *FieldProp) GetPattern() string {
	if x != nil {
		return x.Pattern
	}
	return ""
...
func (x *FieldProp) GetOrder() Order {
	if x != nil {
		return x.Order
	}
...
func (x *FieldProp) GetValidate() string {
	if x != nil {
		return x.Validate
	}
	return ""
...
func (x *FieldProp) GetValidateComplex() string {
	if x != nil {
		return x.ValidateComplex
	}
	return ""
}

func (x *FieldProp) GetValidateMessage() string {
	if x != nil {
		return x.ValidateMessage
	}
	return ""
}

func (x *FieldProp) GetAggregate() bool {
	if x != nil {
		return x.Aggregate
	}
	return false
...
var file_tableau_protobuf_tableau_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x22, 0xa1, 0x02,
	0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b, 0x62, 0x6f, 0x6f, 0x6b, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x3a, 0x4a, 0x0a, 0x05, 0x65, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6e, 0x75, 0x6d,
	0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0xd0, 0x86, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x14, 0x2e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x61, 0x75, 0x2e, 0x45, 0x6e, 0x75, 0x6d, 0x4f, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x05, 0x65, 0x74, 0x79, 0x70, 0x65, 0x3a, 0x56, 0x0a, 0x06,
	0x65, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x21, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	...
	,
	...
	0x6f, 0x2f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x61, 0x75, 0x70, 0x62, 0xa2, 0x02, 0x03, 0x54, 0x50,
	0x42, 0xaa, 0x02, 0x18, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x61, 0x75, 0x2e, 0x50, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x61, 0x75, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_tableau_protobuf_tableau_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
...
var file_tableau_protobuf_tableau_proto_goTypes = []interface{}{
	...
	(Order)(0),                            // 5: tableau.Order
	(*EnumOptions)(nil),                   // 6: tableau.EnumOptions
	(*EnumValueOptions)(nil),              // 7: tableau.EnumValueOptions
	(*StructOptions)(nil),                 // 8: tableau.StructOptions
	(*UnionOptions)(nil),                  // 9: tableau.UnionOptions
	(*OneofOptions)(nil),                  // 10: tableau.OneofOptions
	(*WorkbookOptions)(nil),               // 11: tableau.WorkbookOptions
	(*WorksheetOptions)(nil),              // 12: tableau.WorksheetOptions
	(*FieldOptions)(nil),                  // 13: tableau.FieldOptions
	(*FieldProp)(nil),                     // 14: tableau.FieldProp
	nil,                                   // 15: tableau.WorksheetOptions.LabelsEntry
	nil,                                   // 16: tableau.WorksheetOptions.LangOptionsEntry
...
var file_tableau_protobuf_tableau_proto_depIdxs = []int32{
	15, // 0: tableau.WorksheetOptions.labels:type_name -> tableau.WorksheetOptions.LabelsEntry
	2,  // 1: tableau.WorksheetOptions.mode:type_name -> tableau.Mode
	4,  // 2: tableau.WorksheetOptions.patch:type_name -> tableau.Patch
	16, // 3: tableau.WorksheetOptions.lang_options:type_name -> tableau.WorksheetOptions.LangOptionsEntry
	0,  // 4: tableau.FieldOptions.layout:type_name -> tableau.Layout
	1,  // 5: tableau.FieldOptions.span:type_name -> tableau.Span
	14, // 6: tableau.FieldOptions.prop:type_name -> tableau.FieldProp
	3,  // 7: tableau.FieldProp.form:type_name -> tableau.Form
	4,  // 8: tableau.FieldProp.patch:type_name -> tableau.Patch
	5,  // 9: tableau.FieldProp.order:type_name -> tableau.Order
	17, // 10: tableau.workbook:extendee -> google.protobuf.FileOptions
	18, // 11: tableau.worksheet:extendee -> google.protobuf.MessageOptions
	18, // 12: tableau.struct:extendee -> google.protobuf.MessageOptions
	18, // 13: tableau.union:extendee -> google.protobuf.MessageOptions
	19, // 14: tableau.field:extendee -> google.protobuf.FieldOptions
	20, // 15: tableau.etype:extendee -> google.protobuf.EnumOptions
	21, // 16: tableau.evalue:extendee -> google.protobuf.EnumValueOptions
	22, // 17: tableau.oneof:extendee -> google.protobuf.OneofOptions
	11, // 18: tableau.workbook:type_name -> tableau.WorkbookOptions
	12, // 19: tableau.worksheet:type_name -> tableau.WorksheetOptions
	8,  // 20: tableau.struct:type_name -> tableau.StructOptions
	9,  // 21: tableau.union:type_name -> tableau.UnionOptions
	13, // 22: tableau.field:type_name -> tableau.FieldOptions
	6,  // 23: tableau.etype:type_name -> tableau.EnumOptions
	7,  // 24: tableau.evalue:type_name -> tableau.EnumValueOptions
	10, // 25: tableau.oneof:type_name -> tableau.OneofOptions
