...
var file_tableau_protobuf_wellknown_proto_rawDesc = string([]byte{
	...
	0x57, 0x52, 0x01, 0x77, 0x42, 0x78, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x61, 0x62, 0x6c,
	...
	0x2f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x61, 0x75, 0x70, 0x62, 0xf8, 0x01, 0x01, 0xa2, 0x02, 0x03,
...
var (
	...
	file_tableau_protobuf_wellknown_proto_rawDescData []byte
)

func file_tableau_protobuf_wellknown_proto_rawDescGZIP() []byte {
	file_tableau_protobuf_wellknown_proto_rawDescOnce.Do(func() {
		file_tableau_protobuf_wellknown_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tableau_protobuf_wellknown_proto_rawDesc), len(file_tableau_protobuf_wellknown_proto_rawDesc)))
	})
...
var file_tableau_protobuf_wellknown_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_tableau_protobuf_wellknown_proto_goTypes = []any{
...
func file_tableau_protobuf_wellknown_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tableau_protobuf_wellknown_proto_rawDesc), len(file_tableau_protobuf_wellknown_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
