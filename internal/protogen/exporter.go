...
// writeProtoHeader writes the shared proto file header: the generated-code
// comment, clang-format guard, syntax/edition, package, sorted imports, and
// sorted file-level options.
