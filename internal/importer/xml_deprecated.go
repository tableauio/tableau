...
type XMLImporterDeprecated struct {
	*book.Book
}
...
// TODO: options
func NewXMLImporterDeprecated(filename string, sheets []string, parser book.SheetParser, mode ImporterMode, cloned bool, primaryBookName string) (*XMLImporterDeprecated, error) {
