...
type ProtoInputOption struct {
	...
	// If set, ProtoPaths and ProtoFiles are ignored, and no proto source file
	// is compiled at runtime, which makes tableau independent of the proto
	// language versions (editions) supported by the builtin compiler.
	//
	// The descriptor set file can be generated by an external compiler, e.g.:
	//
	//	protoc -I<proto path> --include_imports --descriptor_set_out=<out file> <proto files>...
	//	buf build -o <out file>
	//
	// NOTE:
	//  - Only one file is allowed, and glob patterns are not supported.
	//  - The descriptor set is the only source of truth, so it must be
	//    self-contained, aka generated with --include_imports.
	//  - The proto files not to be parsed should be excluded when generating
	//    the descriptor set.
...
type ConfInputOption struct {
	...
	// proto source file is compiled at runtime, which makes tableau independent
	// of the proto language versions (editions) supported by the builtin
	// compiler.
	//
	// The descriptor set file can be generated by an external compiler, e.g.:
	//
	...
	//    self-contained, aka generated with --include_imports.
	//  - The proto files not to be parsed should be excluded when generating
	//    the descriptor set, as ExcludedProtoFiles does not apply here.
	//  - It is ignored if the proto files of ProtoPackage are already linked
